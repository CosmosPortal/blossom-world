...
export class ModalHandler extends InteractionHandler {
	public override parse(interaction: ModalSubmitInteraction) {
		if (interaction.customId !== "EditBalanceStash") return this.none();
		return this.some();
	}
	...
	public async run(interaction: ModalSubmitInteraction) {
		...
		if (amount > account.Currency.TokenChestStorage - account.Currency.TokenChest) return void (await CreateResponse.InteractionError(interaction, "You entered an amount higher than what you can store!"));
